...
import static com.github.isabsent.filepicker.SimpleFilePickerDialog.CompositeMode.FILE_ONLY_DIRECT_CHOICE_SELECTION;
...
import static com.github.isabsent.filepicker.SimpleFilePickerDialog.CompositeMode.FOLDER_ONLY_DIRECT_CHOICE_SELECTION;
...
//File picker modes
        ...
        findViewById(R.id.file_direct_postponed).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showListItemDialog(R.string.dialog_title_pick_file, rootPath, FILE_ONLY_DIRECT_CHOICE_SELECTION, PICK_DIALOG);
            }
        });
...
//Folder picker modes
        ...
        findViewById(R.id.folder_direct_postponed).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showListItemDialog(getString(R.string.dialog_title_pick_folder), rootPath, FOLDER_ONLY_DIRECT_CHOICE_SELECTION, PICK_DIALOG);
            }
        });
...
//Mixed picker modes
        ...
        findViewById(R.id.file_or_folder_direct_postponed).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showListItemDialog(R.string.dialog_title_pick_file_or_folder, rootPath, FILE_OR_FOLDER_DIRECT_CHOICE_SELECTION, PICK_DIALOG);
            }
        });
    }
